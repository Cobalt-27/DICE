import torch
from expertpara.diep import cache_size, cache_clear, _cache_put, cache_init

def test_cache_size():
    cache_init(10)
    # Clear caches before starting
    cache_clear()
    from expertpara.diep import _diep_cache_dispatch, _diep_cache_combine
    ...
    _cache_put(_diep_cache_dispatch, 1, tensor1)
    ...
    _cache_put(_diep_cache_combine, 5, tensor2)
